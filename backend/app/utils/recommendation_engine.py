...
ALIASES = {
    ...
    "fashion designer": ["fashion design", "designer"],
    ...
    "army officer": ["army", "defence", "military officer", "soldier officer"],
...
def find_best_career_match(dream_career_input: str, careers: list[dict]) -> dict | None:
    ...
    for career in careers:
        ...
        if normalized_input in aliases or any(normalized_input in a or a in normalized_input for a in aliases):
            return career
