...
Updated 2026-08-03: added joining_lag_months to every exam (default 0),
reflecting the real-world gap between sitting the exam and actually
joining/starting the course - non-zero for defence exams (NDA/CDS/AFCAT),
where SSB interviews, medical tests, and training slot allocation create a
several-month gap between the written exam and course commencement, during
which a candidate can age out even if eligible at exam time.
"""
 ...
 {'slug': 'army-officer',
  ...
  'entrance_exams': [{'name': 'NDA (National Defence Academy) Exam',
                      ...
                      'note': 'Age-bound only (no separate attempt cap); exact cutoff dates vary per '
                              'notification. This estimate also subtracts an approximate 9-month gap between '
                              'the written exam and actual course joining (SSB interview, medical, training '
                              'slot allocation) - eligibility is checked at joining, not at exam '
                              'registration, so real timelines vary by cycle and should be verified against '
                              'the current notification.',
                      'joining_lag_months': 9},
                     {'name': 'CDS (Combined Defence Services) Exam',
                      ...
                      'note': 'Age band varies slightly by entry (IMA/INA/AFA/OTA) - shown range is '
                              "representative; verify against the specific entry's notification. This "
                              'estimate also subtracts an approximate 9-month gap between the written exam '
                              'and actual course joining (SSB interview, medical, training slot allocation) '
                              '- eligibility is checked at joining, not at exam registration, so real '
                              'timelines vary by cycle and should be verified against the current '
                              'notification.',
                      'joining_lag_months': 9},
                     {'name': 'AFCAT (Air Force Common Admission Test)',
                      ...
                      'sessions_per_year': 2,
                      'max_total_attempts': None,
                      'note': 'Flying branch age band shown; Technical/Ground Duty branches allow up to 26. '
                              'This estimate also subtracts an approximate 6-month gap between the written '
                              'exam and actual course joining (SSB interview, medical, training slot '
                              'allocation) - eligibility is checked at joining, not at exam registration, so '
                              'real timelines vary by cycle and should be verified against the current '
                              'notification.',
                      'joining_lag_months': 6}],
