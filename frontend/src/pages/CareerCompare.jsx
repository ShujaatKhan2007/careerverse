...
const ROWS = [
  ...
  { key: 'min_education', label: 'Eligibility to Apply' },
  { key: 'required_degree', label: 'Required Degree' },
  ...
  { key: (c) => c.salary_range.highest_potential, label: 'Highest Potential' },
    ...
    <div className="container" style={{ padding: '32px 24px 80px' }}>
      ...
      {comparison && (
        <div className="compare-page__table-wrap fade-in">
          ...
          <p style={{ fontSize: 12, color: 'var(--text-secondary)', fontStyle: 'italic', padding: '14px 4px' }}>
            Salary figures are approximate and vary by experience, skills, employer, location, industry, and government vs private sector.
          </p>
        </div>
      )}
